...
/**
 * is_palindrome - checks a singly linked list if it is a palindrome
 *
 *@head: pointer to pointer of thje first node in the list passed
 *
 ...
 * @head: pointer to the head toreverse
 */
void reverse(listint_t **head)
{
	listint_t *current;
